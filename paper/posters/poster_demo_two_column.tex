...
\vspace{0.7em}
{\fontsize{19}{23}\selectfont Michal Szlazak, Krzysztof Jurkowski, Arkadiusz Cieplinski, Marek Wdowiak\par}
\vspace{0.3em}
...
\midrule
Lexicon-based & VADER & lightweight baseline with no training, but weakest on complex multi-class tasks \\
Classical ML & TF-IDF + SVM & strong on structured text, competitive on finance and IMDB \\
Deep learning & CNN, LSTM & effective on short and noisy social media data, especially Twitter \\
Transformers & DistilBERT, DistilRoBERTa & strongest supervised models overall, especially in finance \\
LLMs & Gemini, Mistral, Llama & strongest on IMDB and irony, flexible without task-specific fine-tuning \\
\bottomrule
\end{tabular}
\end{center}
...
\midrule
Finance-50 & DistilRoBERTa & 0.865 \\
Finance-66 & DistilRoBERTa & 0.884 \\
Finance-75 & DistilRoBERTa & 0.938 \\
Finance-All & DistilRoBERTa & 0.971 \\
IMDB & Gemini & 0.958 \\
TE-Irony & Gemini & 0.809 \\
TE-Sentiment & DistilRoBERTa & 0.707 \\
Twitter & CNN & 0.866 \\
Yelp-Full & Mistral & 0.666 \\
\bottomrule
\end{tabular}
\end{center}
...
\midrule
LLM-only voting & combine Gemini, Mistral, and Llama & small gains on selected datasets, especially finance \\
Cross-model voting & aggregate all model families & best when errors are complementary \\
Confidence cascade & route easy cases to cheaper models & improves the cost-quality trade-off in practice \\
\bottomrule
\end{tabular}
\end{center}
...
\midrule
Finance-66 & 0.884 & 0.912 & +0.028 \\
Finance-75 & 0.938 & 0.964 & +0.026 \\
Finance-All & 0.971 & 0.980 & +0.009 \\
IMDB & 0.958 & 0.959 & +0.001 \\
Twitter & 0.866 & 0.891* & +0.025 \\
Yelp-Full & 0.666 & 0.659 & -0.007 \\
\bottomrule
\end{tabular}
...
\midrule
Finance-All & 0.308 & 0.106 & 1.10 & 0.00 \\
IMDB & 0.372 & 0.178 & 2.62 & 0.50 \\
TE-Sentiment & 0.519 & 0.344 & 21.39 & 3.37 \\
...
\begin{itemize}[leftmargin=1.2em,itemsep=0.3em,topsep=0.3em]
  \item No single architecture is optimal across all domains.
  \item Finance datasets prefer transformers, IMDB and irony favour LLMs, and Twitter favours CNN/LSTM models.
  \item Confidence-weighted voting is the most reliable ensemble strategy across datasets.
  \item A 0.90 confidence threshold gives a practical balance between quality and computational cost.
  \item Hard examples and correlated errors limit what fixed voting can achieve.
\end{itemize}
